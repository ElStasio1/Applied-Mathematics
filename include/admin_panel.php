...
<div class="container">
    ...
    <div class="admin-buttons">
        ...
        <button class="admin-button add-button" value="i">Наклонный</button>
        <button class="admin-button add-button" value="u">Подчеркивание</button>
        <button class="admin-button add-button" value="content">Контент</button>
        ...
        <button class="admin-button add-button" value="quote">Динннннная цитата</button>
        <button class="admin-button add-button" value="img">Фотография</button>
        <button class="admin-button add-button" value="imgcaption">Подпись к фотографии</button>
        ...
        <button class="admin-button add-button" value="tablerow">Закголовок ячейки</button>
...
[/content]
    ...
    <button id="compile" onclick="compile()">Компиляция</button>
    <div id="compiled"></div>
